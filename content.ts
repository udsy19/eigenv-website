...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    body: 'Seats go empty at the worst possible moments, and hiring under pressure is how expensive mistakes get made. An experienced operator takes the seat within days, running the team, keeping the cadence, steadying the room, so you can search for the permanent answer without a clock ticking behind you.',
  ...
  },
  {
    ...
    body: "Most growth playbooks are borrowed from companies whose users behave nothing like yours. So we start by watching yours: where they arrive, where they stall, where they quietly leave, then build the growth loops on that evidence rather than on someone else's blog post.",
